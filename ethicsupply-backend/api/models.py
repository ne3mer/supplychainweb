...
class Supplier(models.Model):
    ...
    co2_emissions = models.FloatField(null=True, blank=True, default=0)
    delivery_efficiency = models.FloatField(null=True, blank=True, default=0)
    wage_fairness = models.FloatField(null=True, blank=True, default=0)
    human_rights_index = models.FloatField(null=True, blank=True, default=0)
    waste_management_score = models.FloatField(null=True, blank=True, default=0)
